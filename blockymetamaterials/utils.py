...
class MechanicalParams(NamedTuple):
    ...
    Attrs:
        ...
        damping (jnp.ndarray): Either a scalar or an array of shape (n_blocks, 3) representing the damping of each block.
        internal_damping (jnp.ndarray): Either a scalar or an array of shape (3,) or (n_bonds, 3) representing the internal damping of each bond.
...
################# COPY PASTED FROM NEEL'S ANALYSIS_UTILS.PY FILE ################
