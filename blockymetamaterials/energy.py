...
from blockymetamaterials.kinematics import block_to_node_kinematics, block_to_dipole_configuration
...
def edges_distance(edge_1: jnp.ndarray, edge_2: jnp.ndarray):
    ...
    e2_onto_e1_distance = vmap(point_to_edge_distance, in_axes=(0, None))(edge_2, edge_1)
    # Compute the distance projecting first edge on the second edge
    e1_onto_e2_distance = vmap(point_to_edge_distance, in_axes=(0, None))(edge_1, edge_2)
...
def build_contact_energy(bond_connectivity: jnp.ndarray, angle_based=True):
    ...
    void_angle_fn = lambda current_block_nodes: void_angles(current_block_nodes, bond_connectivity)
