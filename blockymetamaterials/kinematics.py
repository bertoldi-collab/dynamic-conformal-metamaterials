...
def build_constrained_kinematics(geometry: Geometry, constrained_block_DOF_pairs: jnp.ndarray, constrained_DOFs_fn: Callable = lambda t, **kwargs: 0):
    ...
    Returns:
        Callable: Constraint function mapping the free DOFs and time to the displacement of all the blocks. The signature is `constrained_kinematics(free_DOFs, t, control_params)`.
    """
