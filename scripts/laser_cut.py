...
from blockymetamaterials.geometry import QuadGeometry, RotatedSquareGeometry, compute_xy_limits
from blockymetamaterials.plotting import generate_polygons
